...
impl<'a> ParseOptions<'a> {
    /// Change the leave relative flag
    pub fn leave_relative(mut self, new: bool) -> Self {
        self.leave_relative = new;
        self
    }
    ...
    pub fn parse(self, input: &str) -> Result<Url, crate::ParseError> {
        Parser {
            ...
            leave_relative: self.leave_relative,
